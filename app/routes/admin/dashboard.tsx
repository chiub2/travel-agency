...
import { ChartComponent, SplineAreaSeries, Inject, DataLabel, Category, ColumnSeries, Tooltip, SeriesCollectionDirective, SeriesDirective, ColumnsDirective, ColumnDirective } from "@syncfusion/ej2-react-charts";
  ...
  return (
    <main className="dashboard wrapper">
      ...
      <section className="container">
        <h1 className="tet-xl font-semibold text-dark-100">Created Trips</h1>
